 ...
 *  当前Item
 */
@property (nonatomic, strong) MCTabbarItem * currentItem;
...
-(void)createTabbar
{
    ...
    _itemType = MCTabbarItemTypeImageAndText1;
...
-(void)createCustomTabbar
{
    ...
    {
        MCTabbarItem * item = [[MCTabbarItem alloc] init];
        ...
        if (configStr.length > 0) {
            if ([configStr hasPrefix:@"m_"]) {
                item.itemType = MCTabbarItemTypeOnlyImage;
            } else if ([configStr hasPrefix:@"mt1_"]) {
                item.itemType = MCTabbarItemTypeImageAndText1;
            }
        ...
        switch (item.itemType) {
            case MCTabbarItemTypeOnlyImage:
            {
                ...
                break;
            case MCTabbarItemTypeImageAndText1:
            {
